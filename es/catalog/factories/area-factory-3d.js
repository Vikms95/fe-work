import { Shape, MeshPhongMaterial, ShapeGeometry, BufferGeometry, Box3, TextureLoader, BackSide, FrontSide, Object3D, Mesh, MeshBasicMaterial, RepeatWrapping, Vector2, DoubleSide, BufferAttribute } from 'three';
...
var assignUVs = function assignUVs(geometry) {
  ...
  var indexCount = geometry.index.count; // this is the amount of faces
...
export function createArea(element, layer, scene, textures) {
  ...
  var areaMaterial = new MeshBasicMaterial({ side: DoubleSide, color: color });
