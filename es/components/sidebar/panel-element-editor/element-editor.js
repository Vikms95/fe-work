...
var ElementEditor = function (_Component) {
  ...
  _createClass(ElementEditor, [{
    ...
    value: function save(_ref2) {
      ...
      if (this.props.state.mode == MODE_DRAWING_LINE && isEnter) this.context.projectActions.next_Drawing_Item();
    }
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('img', { style: { height: '80px', width: '80px', paddingTop: '10px' }, src: element.image }),
          React.createElement(
            'p',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('img', { style: { height: '0.70em', marginLeft: '1.8em', marginTop: '1px' }, src: flecha })
            ),
            React.createElement(
              'div',
              { id: 'panelAcabado',
            ...
            React.createElement(
              ...
              React.createElement('img', { style: { height: '0.70em', marginLeft: '1.6em', marginTop: '1px' }, src: flecha })
            )
          )
        )
      );
