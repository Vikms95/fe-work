...
export default function MenuRooms ( props ) {
  var isDrawMode = useDrawMode( props.state );

  useEffect( () => {
    console.log( 'hello', new MenuProxy() );
  } );
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement( 'img', { src: cuadrada } ),
          React.createElement(
            'p',
            { style: STYLE_NAME },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement( 'img', { src: Recta } ),
          React.createElement(
            'p',
            { style: STYLE_NAME },
            'Pared Recta'
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement( 'img', { src: L1 } ),
          React.createElement(
            'p',
            { style: STYLE_NAME },
            'Dos paredes en L'
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement( 'img', { src: Lizquierda1 } ),
          React.createElement(
            'p',
            { style: STYLE_NAME },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement( 'img', { src: Lderecha1 } ),
          React.createElement(
            'p',
            { style: STYLE_NAME },
            'Habitaci\xF3n en forma de L'
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement( 'img', { src: lapiz } ),
          React.createElement(
            'p',
            { style: STYLE_NAME },
            'Dibujar paredes'
