...
export default function MenuMuebles(props) {
      ...
      elements && elements.map(function (element, key) {
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('img', { src: element.image, style: STYLE_IMAGE }),
            React.createElement(
              'p',
              { style: STYLE_NAME },
              element.name
  ...
  var elementsMueblesBanyo = [{ image: img_fusionChrome, name: 'Fusion Chrome', action: selectFusionChrome }, { image: img_fussionLine, name: 'Fussion Line' }, { image: img_mam, name: 'Mam' }, { image: img_monterrey, name: 'Monterrey' }, { image: img_spirit, name: 'Spirit' }, { image: img_uniiq, name: 'UNiiq' }];

  var elementsLavabo = [{ image: img_lavabos2, name: 'Lavabos', action: selectLavabo2 }, { image: img_lavabosPosar, name: 'Lavabos de posar' }, { image: img_encimeras, name: 'Encimeras' }];

  var elementsCompakt = [{ image: img_compaktFondo46, name: 'Compakt Fondo 46', action: selectCompakt46 }, { image: img_compaktFondo51, name: 'Compakt Fondo 51' }];

  var elementsMamparas = [{ image: img_frontal, name: 'Frontal', action: selectFrontal }, { image: img_angular, name: 'Angular' }, { image: img_pasoLibre, name: 'Paso Libre' }, { image: img_semicircular, name: 'Semicircular' }];

  var elementsPlatosDucha = [{ image: img_rioja, name: 'Rioja', action: selectRioja }, { image: img_pompeya, name: 'Pompeya' }];
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('img', { style: { height: '0.65em', marginTop: '0.85em', marginLeft: '0.2em' }, src: img_flecha })
        ),
        state.currentShowElement === null ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { style: { position: 'relative' } },
              React.createElement('img', { className: 'rectangulo', src: img_rectangulo, style: { marginLeft: '-1.5em', minHeight: '100%' } }),
              React.createElement('img', { src: img_mueblesBanyo, style: STYLE_IMAGE }),
              React.createElement(
                'p',
                { style: STYLE_NAME },
                'Muebles Ba\xF1o'
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { style: { position: 'relative' } },
              React.createElement('img', { className: 'rectangulo', src: img_rectangulo, style: { marginLeft: '-0.9em', minHeight: '100%' } }),
              React.createElement('img', { src: img_lavabos, style: STYLE_IMAGE }),
              React.createElement(
                'p',
                { style: STYLE_NAME },
                'Lavabos y Encimeras'
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { style: { position: 'relative' } },
              React.createElement('img', { className: 'rectangulo', src: img_rectangulo, style: { marginLeft: '-1.5em', minHeight: '100%' } }),
              React.createElement('img', { src: img_compakt, style: STYLE_IMAGE }),
              React.createElement(
                'p',
                { style: STYLE_NAME },
                'Compakt'
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { style: { position: 'relative' } },
              React.createElement('img', { className: 'rectangulo', src: img_rectangulo, style: { marginLeft: '-0.9em', minHeight: '100%' } }),
              React.createElement('img', { src: img_mamparas, style: STYLE_IMAGE }),
              React.createElement(
                'p',
                { style: STYLE_NAME },
                'Mamparas'
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { style: { position: 'relative' } },
              React.createElement('img', { className: 'rectangulo', src: img_rectangulo, style: { marginLeft: '-1.5em', minHeight: '100%' } }),
              React.createElement('img', { src: img_platosDucha, style: STYLE_IMAGE }),
              React.createElement(
                'p',
                { style: STYLE_NAME },
                'Platos de ducha'
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { style: { position: 'relative' } },
              React.createElement('img', { className: 'rectangulo', src: img_rectangulo, style: { marginLeft: '-0.9em', minHeight: '100%' } }),
              React.createElement('img', { src: img_accesorios, style: STYLE_IMAGE }),
              React.createElement(
                'p',
                { style: STYLE_NAME },
                'Accesorios'
