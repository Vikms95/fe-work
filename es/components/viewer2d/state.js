...
export default function State(_ref) {
  ...
  activeSnapElement = activeSnapElement ? React.createElement(Snap, { snap: activeSnapElement, width: '\'' + rejillaTotal + '\'', height: '\'' + rejillaTotal + '\'' }) : null;
  ...
  return React.createElement(
    'g',
    null,
    React.createElement('rect', { x: '0', y: '0', width: '\'' + rejillaTotal + '\'', height: '\'' + rejillaTotal + '\'', fill: SharedStyle.COLORS.white }),
    React.createElement(
      'g',
      ...
      scene.getIn(['guides', 'horizontal']).entrySeq().map(function (_ref2) {
        ...
        return React.createElement('line', { id: 'hGuide' + hgKey, key: hgKey, x1: 0, y1: hgVal, x2: rejillaTotal, y2: hgVal, style: guideStyle });
      }),
      scene.getIn(['guides', 'vertical']).entrySeq().map(function (_ref4) {
        ...
        return React.createElement('line', { key: vgKey, x1: vgVal, y1: 0, x2: vgVal, y2: rejillaTotal, style: guideStyle });
      }),
      activeSnapElement,
      snapElements
    )
