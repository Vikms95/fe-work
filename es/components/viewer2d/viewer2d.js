...
export default function Viewer2D(_ref, _ref2) {
  ...
  useEffect(function () {
    var userZoom = getUserZoom(state);
  ...
  var onKeyDown = function onKeyDown(event) {
    var viewer2DState = getViewer2D(state);
  ...
  var _getViewer2D = getViewer2D(state),
      e = _getViewer2D.e,
      f = _getViewer2D.f,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'svg',
              { width: getRejillaTotal2D(state) / 10, height: getRejillaTotal2D(state) / 10 },
              React.createElement(
                'defs',
                null,
                React.createElement(
