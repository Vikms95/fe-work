import { Mesh, Vector2, Vector3, MeshBasicMaterial, MeshStandardMaterial, Group, BufferGeometry, BoxGeometry, PolyhedronBufferGeometry, Float32BufferAttribute, SphereGeometry, DoubleSide, FrontSide, BackSide, SceneUtils } from 'three';
...
export function buildBox(p0, p1, p2, p3, v02, v13, mat) {
  var p4 = new Vector3().addVectors(p0, v02);
  var p5 = new Vector3().addVectors(p1, v02);
  var p6 = new Vector3().addVectors(p2, v13);
  var p7 = new Vector3().addVectors(p3, v13);
...
export function buildBox2(p0, p1, p2, p3, v02, v13, mat) {
  ...
  var p20 = new Vector2().addVectors(p0, v02);
  var p21 = new Vector2().addVectors(p1, v02);
  var p22 = new Vector2().addVectors(p2, v13);
  var p23 = new Vector2().addVectors(p3, v13);
