import { SET_USER_AUTHENTICATED, SET_PREFERENCES, UPDATE_PREFERENCE, UPDATE_PREFERENCE_COMPLETED, UPDATE_PREFERENCE_FAILED, NEW_PROJECT, LOAD_PROJECT, SAVE_PROJECT, OPEN_CATALOG, SELECT_TOOL_EDIT, UNSELECT_ALL, SET_PROPERTIES, NEXT_DRAWING_ITEM, SET_ITEMS_ATTRIBUTES, SET_LINES_ATTRIBUTES, SET_HOLES_ATTRIBUTES, REMOVE, UNDO, ROLLBACK, OPEN_PROJECT_CONFIGURATOR, SET_PROJECT_PROPERTIES, INIT_CATALOG, UPDATE_MOUSE_COORDS, UPDATE_ZOOM_SCALE, TOGGLE_SNAP, CHANGE_CATALOG_PAGE, GO_BACK_TO_CATALOG_PAGE, THROW_ERROR, THROW_WARNING, COPY_PROPERTIES, PASTE_PROPERTIES, PUSH_LAST_SELECTED_CATALOG_ELEMENT_TO_HISTORY, ALTERATE_STATE, SET_MODE, ADD_HORIZONTAL_GUIDE, ADD_VERTICAL_GUIDE, ADD_CIRCULAR_GUIDE, REMOVE_HORIZONTAL_GUIDE, REMOVE_VERTICAL_GUIDE, REMOVE_CIRCULAR_GUIDE, SET_IS_ELEMENT_SELECTED } from '../constants';

export function SetUserAuthenticated(value) {
  return {
...
export function SetPreference(prefs, prefsInfo) {
  return {
    type: SET_PREFERENCES,
    prefs: prefs, prefsInfo: prefsInfo
  };
}

export function updatePreference(nombre, valor) {
  return {
...
export function updatePreferenceCompleted(nombre, valor) {
  return {
    type: UPDATE_PREFERENCE_COMPLETED,
    nombre: nombre, valor: valor
  };
}

export function updatePreferenceFailed(nombre, valor, error) {
  return {
    type: UPDATE_PREFERENCE_FAILED,
    nombre: nombre, valor: valor, error: error
  };
}
...
export function next_Drawing_Item() {
  return {
    type: NEXT_DRAWING_ITEM
  };
}
...
export function setIsElementSelected(value) {
  return {
    type: SET_IS_ELEMENT_SELECTED,
    value: value
  };
}