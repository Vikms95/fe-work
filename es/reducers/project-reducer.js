...
import { SET_USER_AUTHENTICATED, SET_PREFERENCES, UPDATE_PREFERENCE, NEXT_DRAWING_ITEM, LOAD_PROJECT, NEW_PROJECT, OPEN_CATALOG, SELECT_TOOL_EDIT, MODE_IDLE, UNSELECT_ALL, SET_PROPERTIES, SET_ITEMS_ATTRIBUTES, SET_LINES_ATTRIBUTES, SET_HOLES_ATTRIBUTES, REMOVE, UNDO, ROLLBACK, SET_PROJECT_PROPERTIES, OPEN_PROJECT_CONFIGURATOR, INIT_CATALOG, UPDATE_MOUSE_COORDS, UPDATE_ZOOM_SCALE, TOGGLE_SNAP, CHANGE_CATALOG_PAGE, GO_BACK_TO_CATALOG_PAGE, THROW_ERROR, THROW_WARNING, COPY_PROPERTIES, PASTE_PROPERTIES, PUSH_LAST_SELECTED_CATALOG_ELEMENT_TO_HISTORY, ALTERATE_STATE, SET_MODE, ADD_HORIZONTAL_GUIDE, ADD_VERTICAL_GUIDE, ADD_CIRCULAR_GUIDE, REMOVE_HORIZONTAL_GUIDE, REMOVE_VERTICAL_GUIDE, REMOVE_CIRCULAR_GUIDE, UPDATE_PREFERENCE_COMPLETED, UPDATE_PREFERENCE_FAILED, SET_IS_ELEMENT_SELECTED } from '../constants';
...
export default function (state, action) {
  switch (action.type) {
    ...
    case SET_PREFERENCES:
      return Project.setPreference(state, action.prefs, action.prefsInfo).updatedState;

    case UPDATE_PREFERENCE:
      return Project.updatePreference(state, action.nombre, action.valor).updatedState;

    case UPDATE_PREFERENCE_COMPLETED:
      return Project.updatePreferenceCompleted(state, action.nombre, action.valor).updatedState;

    case UPDATE_PREFERENCE_FAILED:
      return Project.updatePreferenceFailed(state, action.nombre, action.valor, action.error).updatedState;
    ...
    case NEXT_DRAWING_ITEM:
      return Project.next_Drawing_Item(state, state.getIn(['scene', 'selectedLayer'])).updatedState;
    ...
    case SET_IS_ELEMENT_SELECTED:
      return Project.setIsElementSelected(state, action.value).updatedState;
