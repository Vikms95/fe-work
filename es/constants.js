// ACTIONS project
export var SET_USER_AUTHENTICATED = "SET_USER_AUTHENTICATED";
export var SET_PREFERENCES = 'SET_PREFERENCES';
export var UPDATE_PREFERENCE = 'UPDATE_PREFERENCE';
export var UPDATE_PREFERENCE_COMPLETED = 'UPDATE_PREFERENCE_COMPLETED';
export var UPDATE_PREFERENCE_FAILED = 'UPDATE_PREFERENCE_FAILED';
export var NEXT_DRAWING_ITEM = 'NEXT_DRAWING_ITEM';
...
export var SET_IS_ELEMENT_SELECTED = 'SET_IS_ELEMENT_SELECTED';
...
export var CACHE_FONDO = 'CACHE_FONDO';
export var CACHE_ALTO = 'CACHE_ALTO';
export var CACHE_ANGULO = 'CACHE_ANGULO';
...
export var DRAG_VERTEX = 'DRAG_VERTEX';
...
export var BASE_ZOOM = 9.4; // 9.4

export var UNITS_LENGTH = [UNIT_MILLIMETER, UNIT_CENTIMETER, UNIT_METER, UNIT_INCH, UNIT_FOOT, UNIT_MILE];

export var EPSILON = 1e-6;
export var _2_PI = 2 * Math.PI;
export var PI_2 = Math.PI / 2;
export var _3_PI_2 = 3 * Math.PI / 2;
...
export var GUIA2D = 'GUIA2D';
export var GUIA3D = 'GUIA3D';
export var UNIDADMEDIDA = 'UNIDADMEDIDA';
export var VERANGULOS = 'VERANGULOS';
export var C_LISOPARED2D = 'C/LISOPARED2D';
export var C_LISOPARED3D = 'C/LISOPARED3D';
export var C_LINEASCOTA = 'C/LINEASCOTA';
export var C_COTA = 'C/COTA';
export var ALTOPARED = "ALTOPARED";
export var FONDOPARED = "FONDOPARED";
export var T_REJILLA2D = "T/REJILLA2D";
export var T_REJILLA3D = "T/REJILLA3D";
export var ZOOM2D = "ZOOM2D";
export var VER90 = "VER90";
export var FONTS = "FONTS";
export var T_REJILLATOTAL2D = "T/REJILLATOTAL2D";
export var T_REJILLATOTAL3D = "REJILLATOTAL3D";