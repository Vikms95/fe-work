...
Object.assign( MTLLoader.prototype, THREE.EventDispatcher.prototype, {
  ...
  parse: function ( text ) {
    ...
    var materialCreator = new MTLLoader.MaterialCreator( this.texturePath || this.path, this.materialOptions, this.mapImages );
...
MTLLoader.MaterialCreator = function ( baseUrl, options, mapImages ) {
...
MTLLoader.MaterialCreator.prototype = {
  ...
  createMaterial_: function ( materialName ) {
    ...
    //this.materials[materialName].map.minFilter = THREE.LinearFilter;
    //this.materials[materialName].minFilter = THREE.LinearFilter;
