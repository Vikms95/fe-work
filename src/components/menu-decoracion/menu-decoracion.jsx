...
export default function MenuDecoracion ( props ) {
  ...
  //const { menuData } = useFetchMenu( props.menuKey );
  const { itemsActions } = useContext( Context );
  ...
  const closeMenuMuebles = () => {
    ...
    document.getElementById( 'menuDecoracion' ).style.display = 'none';
  };
  ...
  return (
    <aside id='menuDecoracion' style={ STYLE }>
        ...
        <div style={ { display: 'flex', flexDirection: 'column', marginTop: '10px' } } >
          ...
          { ( state.currentShowElement === null )
            ? <div style={ {
              ...
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Bañera' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-1.5em', minHeight: '100%' } } />
                  <img src={ bañera } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Bañera</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'WC' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-0.9em', minHeight: '100%' } } />
                  <img src={ wc } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>WC</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Deco' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-1.5em', minHeight: '100%' } } />
                  <img src={ deco } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Deco</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Jarron1' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-0.9em', minHeight: '100%' } } />
                  <img src={ jarron1 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Jarron1</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Jarron2' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-1.5em', minHeight: '100%' } } />
                  <img src={ jarron2 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Jarron2</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Jarron3' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-0.9em', minHeight: '100%' } } />
                  <img src={ jarron3 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Jarron3</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Planta1' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-1.5em', minHeight: '100%' } } />
                  <img src={ planta1 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Planta1</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Planta2' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-0.9em', minHeight: '100%' } } />
                  <img src={ planta2 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Planta2</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Planta3' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-1.5em', minHeight: '100%' } } />
                  <img src={ planta3 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Planta3</p>
                </div>
              </div>
              <div onClick={ () => itemsActions.selectToolDrawingItem( 'Planta4' ) } style={ { cursor: 'pointer', paddingTop: '10px' } }>
                <div style={ { position: 'relative' } }>
                  <img className={ 'rectangulo' } src={ img_rectangulo } style={ { marginLeft: '-0.9em', minHeight: '100%' } } />
                  <img src={ planta4 } style={ STYLE_IMAGE } />
                  <p style={ STYLE_NAME }>Planta4</p>
                </div>
              </div>
            </div>
