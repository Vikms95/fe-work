...
function Sidebar({ state, width, height, sidebarComponents, projectActions }) {
  ...
  let isSelected = selected.lines.size > 0 ||
    selected.items.size > 0 ||
    selected.holes.size > 0 ||
  ...
  return (
    <div id={'sideBar'} style={isSelected ? { ...STYLE_SELECTED, left: width, height } : { ...STYLE_NOT_SELECTED, height: height }}>
      <aside
        style={STYLE}
      ...
      >
        ...
        <div style={STYLE_TITLE_BAR}>
          ...
          <img style={STYLE_CLOSE} src={close} onClick={hideSideBar} />
        </div>
        {/* Elements */}
