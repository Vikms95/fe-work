...
//     attributesFormData: initAttrData( props.element, props.layer, props.state ),
//     propertiesFormData: initPropData( props.element, props.layer, props.state ),
//   } );

//   //** REPLACE LIFECYCLE */
//   // State = state received from props
//   useEffect( () => {
//     let { element, layer } = props;
//     let scene = props.state.get( 'scene' );
...
//         attributesFormData = attributesFormData.set( attributeName, value );
//         setState( ( prevState ) => ( { ...prevState, attributesFormData } ) );
...
//     let { propertiesFormData } = state;

//     propertiesFormData = propertiesFormData.setIn( [ propertyName, 'currentValue' ], value );
//     setState( ( prevState ) => ( { ...prevState, propertiesFormData } ) );
...
//   let mode = props.state.getIn( [ 'mode' ] );
//   let { state: appState, element } = props;
//   let { projectActions, catalog } = context;
//   let { propertiesFormData, attributesFormData } = state;
