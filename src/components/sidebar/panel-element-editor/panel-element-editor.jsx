...
export default function PanelElementEditor({ state }, { projectActions, translator }) {
  ...
  let layerRenderer = layer => Seq()
    ...
    .map(element => { return componentRenderer(element, layer) })
    .valueSeq();
  ...
  /*  console.log('layer.items', scene.layers.items)*/
  /*console.log('elementsSelected1', elementsSelected)*/
  /*  console.log('elementsSelected2', elementsSelected._root)*/
  return (
