...
exports.SetUserAuthenticated = SetUserAuthenticated;
exports.SetPreference = SetPreference;
exports.updatePreference = updatePreference;
exports.updatePreferenceCompleted = updatePreferenceCompleted;
exports.updatePreferenceFailed = updatePreferenceFailed;
...
exports.next_Drawing_Item = next_Drawing_Item;
...
exports.setIsElementSelected = setIsElementSelected;

var _constants = require('../constants');

function SetUserAuthenticated(value) {
  return {
    type: _constants.SET_USER_AUTHENTICATED,
    value: value
  };
}

function SetPreference(prefs, prefsInfo) {
  return {
    type: _constants.SET_PREFERENCES,
    prefs: prefs, prefsInfo: prefsInfo
  };
}

function updatePreference(nombre, valor) {
  return {
    type: _constants.UPDATE_PREFERENCE,
    nombre: nombre, valor: valor
  };
}

function updatePreferenceCompleted(nombre, valor) {
  return {
    type: _constants.UPDATE_PREFERENCE_COMPLETED,
    nombre: nombre, valor: valor
  };
}

function updatePreferenceFailed(nombre, valor, error) {
  return {
    type: _constants.UPDATE_PREFERENCE_FAILED,
...
function next_Drawing_Item() {
  return {
    type: _constants.NEXT_DRAWING_ITEM
  };
}
...
function setIsElementSelected(value) {
  return {
    type: _constants.SET_IS_ELEMENT_SELECTED,
    value: value
  };
}