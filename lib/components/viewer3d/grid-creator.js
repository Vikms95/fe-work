...
function createGrid(state, scene) {
  ...
  grids.forEach(function (grid) {
    switch (grid.type) {
      case 'horizontal-streak':
        gridMesh.add((0, _gridHorizontalStreak2.default)(state, width, height, grid, font));
        break;
      case 'vertical-streak':
        gridMesh.add((0, _gridVerticalStreak2.default)(state, width, height, grid, font));
        break;
    }
  });
