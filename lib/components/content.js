...
function Content(_ref) {
  ...
  switch (mode) {
    case constants.MODE_3D_VIEW:
      return _react2.default.createElement(_viewer3d2.default, {
        state: state,
        width: width,
        height: height
      });
    ...
    case constants.MODE_3D_FIRST_PERSON:
      return _react2.default.createElement(_viewer3dFirstPerson2.default, {
        state: state,
        width: width,
        height: height
      });
    ...
    case constants.MODE_VIEWING_CATALOG:
      return _react2.default.createElement(_catalogList2.default, {
        state: state,
        width: width,
        height: height
      });
    ...
    case constants.MODE_CONFIGURING_PROJECT:
      return _react2.default.createElement(_projectConfigurator2.default, {
        width: width,
        height: height,
        state: state
      });
    ...
    default:
      if (customContents.hasOwnProperty(mode)) {
        ...
        return _react2.default.createElement(CustomContent, {
          width: width,
          height: height,
          state: state
        });
