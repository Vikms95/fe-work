...
var _usePrevProps = require('../../hooks/usePrevProps');
...
var FormNumberInput = function (_Component) {
  ...
  _createClass(FormNumberInput, [{
    ...
    value: function isLengthInputWhileDrawing() {
      return this.props.attributeName === 'lineLength' && this.props.mode === _constants.MODE_DRAWING_LINE;
    }
  }, {
    ...
    value: function isCachedAnguloWhileDrawing() {
      return (0, _selectors.getCacheAngulo)(this.props.stateRedux) && this.props.stateRedux.get('mode') === _constants.MODE_DRAWING_LINE;
    }
  }, {
    key: 'isInputAnguloAndSingleSelection',
    value: function isInputAnguloAndSingleSelection() {
      return this.props.attributeName === 'angulo' && !(0, _selectors.isMultipleSelection)();
    }
  }, {
    ...
    value: function isSingleSelectionOrInvalidElement() {
      return !this.props.sourceElement || !(0, _selectors.isMultipleSelection)(this.props.stateRedux);
    }
  }, {
    ...
    value: function getAttribute(line) {
      if (!line.vertices) return;
      var layerID = (0, _selectors.getLayerID)(this.props.stateRedux);
      var layer = this.props.stateRedux.getIn(['scene', 'layers', layerID]);

      var _getElementVertices = (0, _selectors.getElementVertices)(line, layer),
          v_a = _getElementVertices.v_a,
          v_b = _getElementVertices.v_b;

      var _getElementAttributes = (0, _selectors.getElementAttributes)(line, layer, v_a, v_b),
          lineLength = _getElementAttributes.lineLength,
          angulo = _getElementAttributes.angulo;

      if (this.props.attributeName === 'lineLength') {
        return (0, _math.toFixedFloat)(lineLength, 2);
      }
      return angulo.angle;
    }
  }, {
    ...
    value: function getSelectedPropertyValues(prototype) {
      var valuesArray = [];
      var elements = (0, _selectors.getSelectedPrototypeElements)(this.props.stateRedux, prototype);
    ...
    value: function componentDidMount() {
      ...
      if (this.isCachedAnguloWhileDrawing() && this.isInputAnguloAndSingleSelection()) {
        this.setState({ showedValue: parseFloat((0, _selectors.getCacheAngulo)(this.props.stateRedux)) });
    ...
    value: function resetInputOnSelection() {
      if (!(0, _selectors.isMultipleSelection)(this.props.stateRedux)) {
    ...
    value: function render() {
      ...
      var saveFn = function saveFn(e, keyCode) {
        ...
        onChange({
          target: {
            isEnter: keyCode == _constants.KEYBOARD_BUTTON_CODE.ENTER,
            value: attributeName === 'angulo' ? savedValue : (0, _changeUnit.convertMeasureToOriginal)(savedValue, _this2.props.unit)
          }
        });
      };
      ...
      var onArrrowPress = function onArrrowPress(e, keyCode) {
        ...
        var layerID = (0, _selectors.getLayerID)(state);

        var _getLineVerticesID = (0, _selectors.getLineVerticesID)(sourceElement),
            vertice1ID = _getLineVerticesID.vertice1ID,
            vertice2ID = _getLineVerticesID.vertice2ID;

        if (vertice1ID === vertice2ID) return;

        var _getVerticeCoords = (0, _selectors.getVerticeCoords)(state, layerID, vertice1ID),
            x1 = _getVerticeCoords.x,
            y1 = _getVerticeCoords.y;

        var _getVerticeCoords2 = (0, _selectors.getVerticeCoords)(state, layerID, vertice2ID),
            x2 = _getVerticeCoords2.x,
            y2 = _getVerticeCoords2.y;

        if (!x1 || !y1 || !x2 || !y2) return;

        var _Line$modifyCoordsOnK = _export.Line.modifyCoordsOnKeyDown(x1, x2, y1, y2, keyCode),
      ...
      var isEscPressed = function isEscPressed(keyCode) {
        return keyCode == _constants.KEYBOARD_BUTTON_CODE.ESC;
      };

      var isSaveButtonPressed = function isSaveButtonPressed(keyCode) {
        return keyCode == _constants.KEYBOARD_BUTTON_CODE.ENTER || keyCode == _constants.KEYBOARD_BUTTON_CODE.TAB && isDifferentValue;
      };

      var isArrowPressedOnLength = function isArrowPressedOnLength(keyCode) {
        return attributeName === 'lineLength' && _constants.KEYBOARD_BUTTON_CODE.ARROW_KEYS.includes(keyCode);
      };

      var isEscPressedWhileDrawing = function isEscPressedWhileDrawing(keyCode) {
        return keyCode == _constants.KEYBOARD_BUTTON_CODE.ESC && _this2.props.mode === _constants.MODE_DRAWING_LINE;
      };
...
FormNumberInput.contextType = _context.Context;
