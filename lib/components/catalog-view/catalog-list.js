...
var CatalogList = function (_Component) {
  ...
  _createClass(CatalogList, [{
    ...
    value: function render() {
        ...
        this.props.state.catalog.path.forEach(function (pathName) {
          breadcrumbsNames.push({
            ...
            action: function action() {
              return _this2.context.projectActions.goBackToCatalogPage(pathName);
            }
          });
        });
      ...
      var selectedHistory = this.props.state.getIn(['scene', 'selectedElementsHistory']);
...
CatalogList.contextType = _context.Context;
