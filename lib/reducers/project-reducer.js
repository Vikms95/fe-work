...
exports.default = function (state, action) {
  switch (action.type) {
    case _constants.SET_USER_AUTHENTICATED:
      return _export2.Project.SetUserAuthenticated(state, action.value).updatedState;

    case _constants.SET_PREFERENCES:
      return _export2.Project.setPreference(state, action.prefs, action.prefsInfo).updatedState;

    case _constants.UPDATE_PREFERENCE:
      return _export2.Project.updatePreference(state, action.nombre, action.valor).updatedState;

    case _constants.UPDATE_PREFERENCE_COMPLETED:
      return _export2.Project.updatePreferenceCompleted(state, action.nombre, action.valor).updatedState;

    case _constants.UPDATE_PREFERENCE_FAILED:
      return _export2.Project.updatePreferenceFailed(state, action.nombre, action.valor, action.error).updatedState;
    ...
    case _constants.NEXT_DRAWING_ITEM:
      return _export2.Project.next_Drawing_Item(state, state.getIn(['scene', 'selectedLayer'])).updatedState;
    ...
    case _constants.SET_IS_ELEMENT_SELECTED:
      return _export2.Project.setIsElementSelected(state, action.value).updatedState;
