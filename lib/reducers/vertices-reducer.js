...
exports.default = function (state, action) {
  switch (action.type) {
    ...
    case _constants.DRAG_VERTEX:
      state = _export.Vertex.beginDraggingVertex(state, action.layerID, action.verticeID, action.x, action.y).updatedState;
      state = _export.Vertex.updateDraggingVertex(state, action.x, action.y, false).updatedState;
      return _export.Vertex.endDraggingVertex(state, action.x, action.y).updatedState;
