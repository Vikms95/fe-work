...
exports.State = exports.HistoryStructure = exports.Catalog = exports.CatalogElement = exports.Scene = exports.DefaultLayers = exports.Group = exports.Layer = exports.Item = exports.Area = exports.Hole = exports.Line = exports.Perimeter = exports.Vertex = exports.ElementsSet = exports.DefaultGrids = exports.Grid = undefined;
...
var Perimeter = exports.Perimeter = function (_Record4) {
  _inherits(Perimeter, _Record4);
  ...
  function Perimeter() {
    ...
    return _possibleConstructorReturn(this, (Perimeter.__proto__ || Object.getPrototypeOf(Perimeter)).call(this, _extends({}, json, {
      lines: new _immutable.List(json.lines || [])
    })));
  }
...
var Line = exports.Line = function (_Record5) {
  _inherits(Line, _Record5);
...
var Hole = exports.Hole = function (_Record6) {
  _inherits(Hole, _Record6);
...
var Area = exports.Area = function (_Record7) {
  _inherits(Area, _Record7);
...
var Item = exports.Item = function (_Record8) {
  _inherits(Item, _Record8);
...
var Scene = exports.Scene = function (_Record11) {
  ...
  function Scene() {
    ...
    return _possibleConstructorReturn(this, (Scene.__proto__ || Object.getPrototypeOf(Scene)).call(this, _extends({}, json, {
      ...
      prefs: new _immutable.Map(json.prefs || {})
    })));
  }
...
var State = exports.State = function (_Record15) {
  ...
  function State() {
    ...
    return _possibleConstructorReturn(this, (State.__proto__ || Object.getPrototypeOf(State)).call(this, _extends({}, json, {
      ...
      actions: new _immutable.List(json.actions || [])
    })));
  }
